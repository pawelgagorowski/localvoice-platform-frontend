        ...
        <div class="sign-three relative">
          ...
          <div class="sign-three-content z-10">
            <div class="section-left-content">
              <h1 class="text-4xl font-weight-bold white--text">Don't have an account?</h1>
              <p class="font-weight-medium body-2">Stop wasting time and money. It's free!</p>
              <v-btn large color="orange white--text">Sign Up</v-btn>
            </div>
          </div>
        </div>
      </v-col>
          ...
          <div class="d-flex justify-center align-center text-center md:h-screen h-full">
            <div class="w-4/5">
              <v-avatar class="mb-8" size="200" tile>
                <img src="@/assets/images/illustrations/breaking_barriers.svg" />
              </v-avatar>

              <v-form>
                <v-text-field prepend-icon="mdi-account" label="Username" class="mb-4"></v-text-field>
                <v-text-field
                ...
                ></v-text-field>
                <v-checkbox v-model="selected" label="I Agree With Terms And Conditions" value="John"></v-checkbox>
              </v-form>
              ...
              <div class="text-center">
                <h6 class="card-title font-extrabold">Sign In With</h6>
