 ...
 * ```
 */
export function createGetterMap<K extends Record<string, unknown>, S, R>(
  namespace: string,
...
export function createActionMap<K extends Record<string, unknown>, S, R>(
  namespace: string,
...
export interface MutationName {
  namespaced: string;
  local: string;
}

export function createMutationMap<K extends Record<string, unknown>, S>(
  namespace: string,
  mutations: MutationTree<S>
): { [key in keyof K]: MutationName } {
